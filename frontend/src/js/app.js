...
import { updateStatusConfig, GAS_ALERT_THRESHOLD, CO2_ALERT_THRESHOLD, getBusStatus, getCOCategory, getCO2Category } from './status.js';
...
map.on('load', () => {
    ...
    const handleBusUpdate = (bus) => {
        ...
        if (existingItem) {
            ...
            const timeStr = formatTimestamp(bus.created_at);
